let calcTax,calcMomsSum,calcMoms,print;_2a0‍.w("./tax",[["default",["calcTax"],function(v){calcTax=v}]]);_2a0‍.w("./tax2",[["default",["calcMomsSum"],function(v){calcMomsSum=v}],["calcMoms",["calcMoms"],function(v){calcMoms=v}]]);_2a0‍.w("./print",[["*",null,function(v){print=v}]]);
